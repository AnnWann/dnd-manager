/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5cd7545b897250256f1c13500058cec5)
// Runtime types generated with workerd@1.20260828.1 2026-08-18 
interface __BaseEnv_Env {
	SESSION_AUTH_MODE: "token";
	SESSION_ACTOR: DurableObjectNamespace<import("./src/routes/index").SessionActor>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/routes/index");
		durableNamespaces: "SessionActor";
	}
	interface QaEnv {
		SESSION_AUTH_MODE: "token";
		SESSION_ACTOR: DurableObjectNamespace<import("./src/routes/index").SessionActor>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SESSION_AUTH_MODE">> {}
}
