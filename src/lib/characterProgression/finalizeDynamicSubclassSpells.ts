...
import { getDynamicSubclassSpellGrants } from "../../models/leveling/DynamicSubclassSpellRules"
import {
  createClassEntry,
  normalizeSpellName,
...
export type CharacterProgressionMode = "creation" | "level-up"

export function finalizeDynamicSubclassSpells(
  character: CharacterTemplate,
  spells: Spell[],
  mode: CharacterProgressionMode,
): CharacterTemplate {
