                        ...
                        <div
                          className={
                            sessionId && !isCreationMode
                              ? "mx-auto w-full min-w-0 max-w-7xl overflow-x-hidden px-3 pt-4 pb-20 sm:px-4 sm:pt-6 sm:pb-20 xl:pb-6"
                              : "mx-auto w-full min-w-0 max-w-7xl overflow-x-hidden px-3 py-4 sm:px-4 sm:py-6"
                          }
                        >
                          <AppRouter />
                        </div>
